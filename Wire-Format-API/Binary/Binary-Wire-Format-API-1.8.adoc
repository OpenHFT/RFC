...
If send a typed message, for example a message of type "!MyType" then we are also going to send an (0x88) anchor tag as well as a ( 0x87) field anchor as we did in the section on non typed messages above.
