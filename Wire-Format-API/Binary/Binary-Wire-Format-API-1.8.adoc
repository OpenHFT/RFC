...
|===
| type   | 7bit   | 6bit   | 5bit   | 4bit   | 3bit   | 2bit   | 1bit   | 0bit
| FieldAnchor ( 0x87 ) see exampled on DeltaWire below                      | 1   | 0   | 0   | 0   | 0   | 0   | 1    |
|===
...
|===
| type   | 7bit   | 6bit   | 5bit   | 4bit   | 3bit   | 2bit   | 1bit   | 0bit
| FieldNumber ( 0xBA ) see exampled on DeltaWire below                       | 1   | 0   | 1   | 1   | 1   | 0   | 1    |  0  |
|===
...
|===
| (0x87) -  FIELD_ANCHOR   - special control message to denote delta wire field
| (0x00) -  field tag ( store tag to field locally, overwrite local cache is used by existing )
| (0x05) -  field len
| (0x68) - ‘h’ as Ascii
| (0x65) - ‘e’ as Ascii
| (0x6C) - ‘l’ as Ascii
