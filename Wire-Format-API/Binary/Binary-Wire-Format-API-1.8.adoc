...
[source]
C5 68 65 6C 6C 6F 82 12  00 00 00 C2 66 31 E5 68 65 6C 6C 6F C2 66 32 E5 77 6F 72 6C 64
...
in the example above we only tokenize the fields, but if we use typed object we tokenize the values as well by the user of the (0x88) tag

if send the message of a known type for example "!MyType"
...
if we send this message twice in delta wire
...
87 00 05 68 65 6C 6C 6F 82 16 00 00 00 87 01 02 66 31 E5 68 65 6C 6C 6F 87 02 02 66 32 E5 77 6F 72 6C 64
BA 00                   82 13 00 00 00 BA 01          E5 68 65 6C 6C 6F BA 02          E8 75 6E 69 76 65 72 73 65
