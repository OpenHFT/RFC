...
If we had the following Text Yaml
{hello: 1} 

note: where the key is ‘hello’ as a field and the value is ‘1’ as and integer

in Binary Wire this would encode to the following bytes
...
however with DELTA binary this becomes

[source]
87 00 05 68 65 6C 6C 6F  01  

|===
| (0x87) -  FIELD_ANCHOR   - special tag to denote delta wire field    
| (0x00) -  ?       
| (0x05) -  field len    
| (0x68) - ‘h’ as Ascii       
| (0x65) - ‘e’ as Ascii       
...
the delta wire is a more compact format once the message is sent a second time, for the same field.
so the following
...
would become this in binary wire 
[source]
C5 68 65 6C 6C 6F 01 C5  68 65 6C 6C 6F 01 C5  68 65 6C 6C 6F 01

and this in delta wire
[source]
87 00 05 68 65 6C 6C 6F  01 BA 00 01 BA 00 01

where this is the first ‘hello: 1’
[source]
87 00 05 68 65 6C 6C 6F  01 

and the subsequent  ‘hello: 1, hello: 1’
